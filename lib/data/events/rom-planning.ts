...
export const romPlanningEvents: GameEvent[] = [
  ...
  },
  {
    ...
    choices: [
      {
        id: 'rom-2-a',
        text: 'リスク・品質・調達の各計画を包括的に策定する。定量的リスク分析も実施。',
        effects: {
          costImpact: 80,
          scheduleImpact: 0.5,
          ...
          riskImpacts: [
            { action: 'add', riskId: 'risk-requirements-gap', description: '要件認識のズレによる手戻り', probability: 'medium', impact: 'high', response: 'プロトタイプレビューと段階的な要件確認' },
            { action: 'add', riskId: 'risk-tech-selection', description: '技術選定の失敗による品質リスク', probability: 'low', impact: 'high', response: 'POC実施と技術検証' },
            { action: 'add', riskId: 'risk-user-adoption', description: '営業担当のシステム定着リスク', probability: 'medium', impact: 'medium', response: '段階的導入と研修プログラム' },
          ],
        },
        feedback: '包括的なPM計画は、問題発生時の対応力を大幅に向上させます。',
        pmbokReference: 'PMBOK: プロジェクト・リスク・マネジメント - リスク特定→定性的分析→定量的分析→対応策立案のプロセスを順に実施することが推奨されます。',
      },
      {
        id: 'rom-2-b',
        text: '影響度の高いリスク上位5つに絞って対応策を策定し、品質・調達は要件定義後に計画する。',
        effects: {
          costImpact: 0,
          scheduleImpact: 0,
          ...
          stakeholderImpacts: [],
          riskImpacts: [
            { action: 'add', riskId: 'risk-requirements-gap', description: '要件認識のズレによる手戻り', probability: 'medium', impact: 'high', response: '要件レビューの強化' },
            { action: 'add', riskId: 'risk-tech-selection', description: '技術選定の失敗', probability: 'low', impact: 'high', response: '基本的な技術検証' },
          ],
        },
        feedback: '重要リスクへの集中は効率的ですが、品質・調達計画の後回しはリスクを伴います。',
        pmbokReference: 'PMBOK: プロジェクト・リスク・マネジメント - リスクの優先順位付けは限られたリソースの有効活用に役立ちます。',
      },
      {
        id: 'rom-2-c',
        ...
        feedback: 'リスクへの事後対応は、問題発生時のコストが事前対応の数倍になることがあります。',
        pmbokReference: 'PMBOK: プロジェクト・リスク・マネジメント - 予防的リスク対応（回避・軽減・転嫁）は、受容（事後対応）より効果的です。',
      },
    ],
